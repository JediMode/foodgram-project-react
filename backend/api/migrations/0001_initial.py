# Generated by Django 3.2.6 on 2022-08-26 20:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.FloatField(validators=[api.validators.validate_greater_than_zero], verbose_name='Время приготовления (в минутах)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200, unique=True, verbose_name='Название')),
                ('color', colorfield.fields.ColorField(default='#FFFFFF', image_field=None, max_length=7, samples=[('#FF0000', 'Красный'), ('#FFA500', 'Оранжевый'), ('#FFFF00', 'Жёлтый'), ('#008000', 'Зелёный'), ('#0000FF', 'Синий')], unique=True, verbose_name='Цвет в НЕХ')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.FloatField(validators=[api.validators.validate_greater_than_zero], verbose_name='Количество')),
